...
public final class R {
  ...
  public static final class string {
    ...
    public static final int kindle_ip=0x7f0a0002;
    public static final int kindle_ip_summ=0x7f0a0003;
    public static final int password=0x7f0a0004;
    public static final int password_summ=0x7f0a0005;
    ...
    public static final int username_summ=0x7f0a0017;
  }
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha pl.whipsoft.kindleturn:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name pl.whipsoft.kindleturn:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #CoordinatorLayout_keylines pl.whipsoft.kindleturn:keylines}</code></td><td>A reference to an array of integers representing the
     * locations of horizontal keylines in dp from the starting edge.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_statusBarBackground pl.whipsoft.kindleturn:statusBarBackground}</code></td><td>Drawable to display behind the status bar when the view is set to draw behind it.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name pl.whipsoft.kindleturn:keylines
     */
     ...
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name pl.whipsoft.kindleturn:statusBarBackground
     */
     ...
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchor pl.whipsoft.kindleturn:layout_anchor}</code></td><td>The id of an anchor view that this view should position relative to.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchorGravity pl.whipsoft.kindleturn:layout_anchorGravity}</code></td><td>Specifies how an object should position relative to an anchor, on both the X and Y axes,
     * within its parent's bounds.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_behavior pl.whipsoft.kindleturn:layout_behavior}</code></td><td>The class name of a Behavior class defining special runtime behavior
     * for this child view.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_dodgeInsetEdges pl.whipsoft.kindleturn:layout_dodgeInsetEdges}</code></td><td>Specifies how this view dodges the inset edges of the CoordinatorLayout.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_insetEdge pl.whipsoft.kindleturn:layout_insetEdge}</code></td><td>Specifies how this view insets the CoordinatorLayout and make some other views
     * dodge it.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_keyline pl.whipsoft.kindleturn:layout_keyline}</code></td><td>The index of a keyline this view should position relative to.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name pl.whipsoft.kindleturn:layout_anchor
     */
     ...
     * </table>
     *
     * @attr name pl.whipsoft.kindleturn:layout_anchorGravity
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name pl.whipsoft.kindleturn:layout_behavior
     */
     ...
     * </table>
     *
     * @attr name pl.whipsoft.kindleturn:layout_dodgeInsetEdges
     */
     ...
     * </table>
     *
     * @attr name pl.whipsoft.kindleturn:layout_insetEdge
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name pl.whipsoft.kindleturn:layout_keyline
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority pl.whipsoft.kindleturn:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts pl.whipsoft.kindleturn:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy pl.whipsoft.kindleturn:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout pl.whipsoft.kindleturn:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage pl.whipsoft.kindleturn:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery pl.whipsoft.kindleturn:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name pl.whipsoft.kindleturn:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name pl.whipsoft.kindleturn:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name pl.whipsoft.kindleturn:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name pl.whipsoft.kindleturn:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name pl.whipsoft.kindleturn:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name pl.whipsoft.kindleturn:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font pl.whipsoft.kindleturn:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle pl.whipsoft.kindleturn:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings pl.whipsoft.kindleturn:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight pl.whipsoft.kindleturn:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex pl.whipsoft.kindleturn:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name pl.whipsoft.kindleturn:font
     */
     ...
     * </table>
     *
     * @attr name pl.whipsoft.kindleturn:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name pl.whipsoft.kindleturn:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name pl.whipsoft.kindleturn:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name pl.whipsoft.kindleturn:ttcIndex
     */
  ...
  public static final class xml {
    public static final int pref_data_sync=0x7f0d0000;
    public static final int pref_general=0x7f0d0001;
    public static final int pref_headers=0x7f0d0002;
    public static final int pref_notification=0x7f0d0003;
